...
def load_win_x64_android_arm_gcc_common_settings(conf):
	...
	v['DEFINES'] += ['_LINUX', 'LINUX', 'LINUX32', 'ANDROID', 'MOBILE', '_HAS_C9X' ]
...
def process_android_java_files(self):
	...
	final_bin_outpath = bld.get_output_folders(platform)[0]
...
def add_android_lib_copy(self):
	...
	debug_lib_output = bld.get_output_folders(platform)[0].make_node('lib_debug')
